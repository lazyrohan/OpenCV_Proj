...
// ImageProcDoc.cpp : CImageProcDoc 类的实现
//
...
// 缩略图的支持
void CImageProcDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CImageProcDoc::InitializeSearchContent()
{
...
void CImageProcDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
